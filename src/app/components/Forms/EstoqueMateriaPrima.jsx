...
export const EstoqueMateriaPrima = ({ materiais, onClearAll, modoEdicao, onEditClick, onRequestSubmit, onRequestDelete, fornecedores, tiposProduto }) => {
    ...
    const abas = [
        {
            ...
            campos: [
                { campo: 'tipo', label: 'Tipo de Matéria-prima' },
        ...
        <Paper elevation={0} className="p-6 mt-6" sx={{ marginTop: '25px', padding: 3 }}>
            <div style={{ marginBottom: 20 }}>
                <Typography variant="h5" component="h2" fontWeight={600}>
                    {isNovoCadastro ? 'Matéria-prima' : 'Matéria-prima Selecionada'}
                </Typography>
                <Typography variant="body1" color="text.secondary">
                    {isNovoCadastro
                        ? 'Preencha os dados abaixo para cadastrar uma novo Matéria-prima.'
                        : 'Informações detalhadas da Matéria-prima.'}
                </Typography>
            </div>
